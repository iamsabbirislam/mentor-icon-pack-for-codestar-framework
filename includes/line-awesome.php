...
if ( !function_exists( 'mentor_icon_pack_line_awesome' ) ) {

    function mentor_icon_pack_line_awesome( $icons ) {

        $icons[] = array(
            'title' => esc_html__( 'Line Awesome', 'mentor-icon-pack' ),
            'icons' => array(
    ...
    add_filter( 'csf_field_icon_add_icons', 'mentor_icon_pack_line_awesome' );
}