...
if ( !function_exists( 'mentor_icon_pack_dripicon' ) ) {

    function mentor_icon_pack_dripicon( $icons ) {

        $icons[] = array(
            'title' => esc_html__( 'Drip Icon', 'mentor-icon-pack' ),
            'icons' => array(
                'dripicons-alarm',
    ...
    add_filter( 'csf_field_icon_add_icons', 'mentor_icon_pack_dripicon' );
}