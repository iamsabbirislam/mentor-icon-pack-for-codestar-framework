...
if ( !function_exists( 'mentor_icon_pack_material_design' ) ) {

    function mentor_icon_pack_material_design( $icons ) {

        $icons[] = array(
            'title' => esc_html__( 'Material Design', 'mentor-icon-pack' ),
            'icons' => array(
                'mdi mdi-allergy',
    ...
    add_filter( 'csf_field_icon_add_icons', 'mentor_icon_pack_material_design' );
}