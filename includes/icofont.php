...
if ( !function_exists( 'mentor_icon_pack_icofont' ) ) {

    function mentor_icon_pack_icofont( $icons ) {

        $icons[] = array(
            'title' => esc_html__( 'Icofont', 'mentor-icon-pack' ),
            'icons' => array(
                'icofont-addons',
    ...
    add_filter( 'csf_field_icon_add_icons', 'mentor_icon_pack_icofont' );
}