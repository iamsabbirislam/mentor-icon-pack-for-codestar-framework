...
if ( !function_exists( 'mentor_icon_pack_elementor' ) ) {

    function mentor_icon_pack_elementor( $icons ) {

        $icons[] = array(
            'title' => esc_html__( 'Elementor Icon', 'mentor-icon-pack' ),
            'icons' => array(
                'eicon-editor-link',
                'eicon-editor-unlink',
    ...
    add_filter( 'csf_field_icon_add_icons', 'mentor_icon_pack_elementor' );
}